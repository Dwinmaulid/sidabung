...
<table width="100%" border="0" cellpadding="4" cellspacing="1" bordercolor="#F0F0F0" bgcolor="#66CCCC">
  <tr>
    ...
    <?php
    $query=mysqli_query($koneksi, "SELECT relasi.kd_gejala,relasi.kd_penyakit,penyakit_solusi.kd_penyakit,penyakit_solusi.nama_penyakit AS penyakit FROM relasi,penyakit_solusi WHERE penyakit_solusi.kd_penyakit=relasi.kd_penyakit GROUP BY relasi.kd_penyakit")or die(mysqli_error());
	$no=0;
